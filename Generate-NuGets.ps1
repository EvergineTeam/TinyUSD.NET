...
.DESCRIPTION
	This script generates NuGet packages for the TinyUSD for Evergine
...
param (
	...
	[string]$bindingsCsprojPath = "TinyUSDGen\Evergine.Bindings.TinyUSD\Evergine.Bindings.TinyUSD.csproj"
)
